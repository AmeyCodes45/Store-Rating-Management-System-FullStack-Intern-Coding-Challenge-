...
import { X, Eye, EyeOff, User, Mail, MapPin, Lock } from 'lucide-react';
...
const schema = yup.object({
  ...
  address: yup.string().max(400, 'Address must be at most 400 characters').required('Address is required'),
  password: yup.string()
